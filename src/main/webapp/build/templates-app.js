angular.module('templates-app', ['about/about.tpl.html', 'expenses/expenses.tpl.html', 'home/home.tpl.html']);
...
angular.module("expenses/expenses.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("expenses/expenses.tpl.html",
    ...
    "                <select class=\"btn btn-default\" type=\"button\" id=\"dropdownMenu1\" data-toggle=\"dropdown\"\n" +
    "                        ng-change=\"changed()\"\n" +
    "                        ng-model=\"fundType\"\n" +
    "                        ng-options=\"types.name for types in fundTypes\">\n" +
    "                    <option value=\"\" ng-if=\"false\"></option>\n" +
    "                </select>\n" +
    "            </div>\n" +
    "            <!-- /btn-group -->\n" +
    "            <input type=\"text\" class=\"form-control\" aria-label=\"...\" ng-model=\"funds\">\n" +
    "        </div>\n" +
    "        <!-- /input-group -->\n" +
    "    </div>\n" +
    "    <button type=\"submit\" class=\"btn btn-primary\" ng-click=\"transfer()\">Transfer</button>\n" +
    "    {{result}}\n" +
    "\n" +
    "</div>\n" +
    "<!-- /.row -->\n" +
...
angular.module("home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/home.tpl.html",
    ...
    "      Read the Docs\n" +
    "    </a>\n" +
    "    <a href=\"https://github.com/ngbp/ngbp\" class=\"btn btn-large btn-message\">\n" +
